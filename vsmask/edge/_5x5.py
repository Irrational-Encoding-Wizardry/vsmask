...
from ._abstract import EdgeDetect, EuclidianDistanceMatrixDetect, MaxDetect, SingleMatrixDetect
...
class ExSobel(EuclidianDistanceMatrixDetect, Matrix5x5):
...
class FDoG(EuclidianDistanceMatrixDetect, Matrix5x5):
...
class DoG(EuclidianDistanceMatrixDetect, Matrix5x5):
...
class Farid(EuclidianDistanceMatrixDetect, Matrix5x5):
